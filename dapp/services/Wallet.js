          ...
          return Web3Service.web3.eth.getGasPrice.request(
            function (e, gasPrice) {
              if (e) {
                ...
                wallet.txParams.gasPrice = Math.max(txDefault.gasPrice,gasPrice.toNumber());
                cb(null, gasPrice);
              }
            }
          );
          ...
          return Web3Service.web3.eth.getBlock.request(
            ...
            function (e, block) {
              if (e) {
                ...
                wallet.txParams.gasLimit = Math.min(txDefault.gasLimit,Math.floor(block.gasLimit*0.9));
